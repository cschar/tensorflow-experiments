...
import cv2
cap = cv2.VideoCapture(r'C:/Kaggle_data/macncheese.mp4')
...
#https://github.com/tensorflow/tensorflow/issues/6698#issuecomment-364702793
# update driver...
...
# but labels jupyter notebook example
# when passing in image_paths
#
# see if we can read in frame, save as image
# pass in path and see if it THEN classifies.
#
#
